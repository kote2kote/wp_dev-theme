<?php
/**
 * wp_dev_theme functions and definitions
 *
...
if ( ! function_exists( 'wp_dev_theme_setup' ) ) :
	/**
	 ...
	 */
	function wp_dev_theme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on wp_dev_theme, use a find and replace
		 * to change 'wp_dev_theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'wp_dev_theme', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'wp_dev_theme_custom_background_args', array(
 ...
 */
function wp_dev_theme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'wp_dev_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'wp_dev_theme_content_width', 0 );
 ...
 */
function wp_dev_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wp_dev_theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wp_dev_theme' ),
...
add_action( 'widgets_init', 'wp_dev_theme_widgets_init' );
...
function wp_dev_theme_scripts() {
  ...
  $id = date("YmdHis"); ;
    ...
    wp_enqueue_style( 'wp_dev_theme-style', get_template_directory_uri() . '/rinn_style.css', array(), $id );
	} else if(is_page("onigiri")) {
    wp_enqueue_style( 'wp_dev_theme-style', get_template_directory_uri() . '/onigiri_style.css', array(), $id );
	} else {
  ...
  //JS
	...
	wp_enqueue_script( 'wp_dev_theme-skrollr-js', 'https://cdnjs.cloudflare.com/ajax/libs/skrollr/0.6.30/skrollr.min.js', array(), $id, true);
  ...
  if(is_page("hohoemi")) {
		...
		wp_enqueue_script( 'wp_dev_theme-script-js', get_template_directory_uri(). '/assets/js/rinn.min.js', array(), $id, true);
	} else if(is_page("rinn")) {
		wp_enqueue_script( 'wp_dev_theme-script-js', get_template_directory_uri(). '/assets/js/onigiri.min.js', array(), $id, true);
	} else {
...
add_action( 'wp_enqueue_scripts', 'wp_dev_theme_scripts' );
